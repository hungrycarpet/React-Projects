...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        <h1 className="text-4xt sm:text-6xl lg:text-7xl text-center tracking-wide">
            Virtual build tool 
        ...
        <div className="flex flex-col sm:flex-row mt-10 justify-center items-center sm:items-start px-4">
            <video
                autoPlay
                loop
                muted
                className="rounded-lg w-full sm:w-1/2 max-w-xs sm:max-w-md lg:max-w-lg border border-orange-700 shadow-sm shadow-orange-400 m-2">
